class PeachForensics < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kalink0/peach-forensics/releases/download/v#{version}/peach-macos-arm-v#{version}.tar.gz"
      sha256 "998dee6919d4c7c69d6a5924fcf52b8e50aa7cd05fbb20fca78cc249af323073"
    end

    on_intel do
      url "https://github.com/kalink0/peach-forensics/releases/download/v#{version}/peach-macos-intel-v#{version}.tar.gz"
